...
- be able to calculate whether it has enough paint to paint a room
...
- be able to decrease amount of paint in stock when painting a room
- be able to remove empty paint cans from stock
